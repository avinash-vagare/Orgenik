			...
			<div class="row">
				...
				<div class="col-lg-3 col-sm-6 col-md-6">
					<div class="footer-widget footer-contact mb-5 mb-lg-0">
						...
						<ul class="list-unstyled">
							<li> <i class="fa fa-map-marker"></i>Vasud Chok Sangola 413309</li>
							<li> <i class="fa fa-envelope"></i>info@yourdomain.com</li>
							<li><i class="fa fa-phone"></i>9960804216</li>
			...
			<div class="row copyright-bg">
				<div class="col-lg-6">
					<div class="copyright text-lg-left text-center">
						<p>&copy; Copyright reserved to <a href="themeturn.html">Orgenik</a>by Avinash-2024</p>
					</div>
				</div>
				<div class="col-lg-6">
...
<!-- Mirrored from pxelcode.com/tf-db/orgenik-demo/orgenik/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 May 2024 10:04:53 GMT -->
</html>